...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", type=Path, default=Path("data/raw/baza_telecom_v2.csv"))
    parser.add_argument("--output", type=Path, default=Path("data/processed/baza_telecom_v2_processed.csv"))
